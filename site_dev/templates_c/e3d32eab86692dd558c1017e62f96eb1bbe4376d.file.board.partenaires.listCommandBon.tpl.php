<?php /* Smarty version Smarty-3.1.7, created on 2012-07-10 16:40:57
         compiled from "templates/admin/pages/board.partenaires.listCommandBon.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18779008694ffc3ef96e6a02-76178455%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3d32eab86692dd558c1017e62f96eb1bbe4376d' => 
    array (
      0 => 'templates/admin/pages/board.partenaires.listCommandBon.tpl',
      1 => 1334791203,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18779008694ffc3ef96e6a02-76178455',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4ffc3ef9736d6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4ffc3ef9736d6')) {function content_4ffc3ef9736d6($_smarty_tpl) {?><div id="main">
	...
	<br /><br />
	<a target="_blank" href="cartes-enveloppesBISBISsavePARTNERfact.php"><strong>Exporter la liste des adresses </strong></a>
	<br /><br />
	...
	<table cellspacing="1" style="width:100%;">
		...
		<tr>
			...
			<th style="width:75px;"><strong>Date</strong> <a href="http://admin.inrees.com/adm/index.php?cat=magazine&scat=gestioncommandes&orderby=<<?php ?>?php if($_GET["orderby"] == "montant") { echo "montant2" ; } else { echo "montant" ; } ?<?php ?>>"><img src="http://admin.inrees.com/adm/images/arrow_white_trans.gif" width="7" height="13" /></a></th>
			<th><strong>Retour</strong> <a href="http://admin.inrees.com/adm/index.php?cat=magazine&scat=gestioncommandes&orderby=<<?php ?>?php if($_GET["orderby"] == "reglement") { echo "reglement2" ; } else { echo "reglement" ; } ?<?php ?>>"><img src="http://admin.inrees.com/adm/images/arrow_white_trans.gif" width="7" height="13" /></a></th>
		...
		<tbody>
			...
			$requete = "SELECT * FROM admin_libcomm, in_partenaires WHERE partenaires_id = libcomm_idpartner AND libcomm_statut = '1' ORDER BY ".$orderby.$limit ;
			...
			' ;
				...
				else
				{
						...
						echo '<a href="http://admin.inrees.com/adm/index.php?cat=partenaires&scat=bonDepotFacture&id='.$row['libcomm_idpartner'].'&idfact='.$row['libcomm_id'].'" title="Facture"><img src="http://admin.inrees.com/adm/images/iconEdit.gif" width="14px" height="14px" /></a>' ;
							...
							{
								if($row['libcomm_paiement'] == 0)
									{
								echo '<a href="http://admin.inrees.com/adm/bonDepot33factPay.php?id='.$row['libcomm_id'].'" title="Facture"><img src="http://admin.inrees.com/adm/images/icon_sync_disabled.gif" width="14px" height="14px" /></a>' ;
									}
							}
	...
	//			}
				...
				if($_GET['limit'] == "1")
				{
					echo '
					<tr>
					<td colspan="5"><center><a href="http://admin.inrees.com/adm/index.php?cat=partenaires&scat=listCommandBon"><strong> >>> REDUIRE L\'AFFICHAGE <<< </strong></center></td>
					</tr>
					' ;
				}
				else
				{
					echo '
					<tr>
					<td colspan="5"><center><a href="http://admin.inrees.com/adm/index.php?cat=partenaires&scat=listCommandBon&limit=1"><strong> >>> AFFICHER TOUS LES MESSAGES <<< </strong></center></td>
					</tr>
					' ;
				}
