			...
			<div class="container">
				...
				<div class="home">
					...
					<div style="width: 990px; height: 348px; overflow: hidden; background-color: #000000; cursor: pointer;">
						{if ($ban.banType) == 1}
							{include file='index.banniere.1.tpl'}
						{elseif ($ban.banType) == 3}
							{include file='index.banniere.3.tpl'}
						{elseif ($ban.banType) == 6}
							{include file='index.banniere.6.tpl'}
						{/if}
					</div>
					<div class="repererb"></div>
					<div class="magThemes" style="margin-bottom:15px;">
						<div style="float:right;">
							<form style="top:-3px; position:relative;" action="rechercher.php" method="get">{literal}
								<input type="text" onblur="if (this.value == '') {this.value = 'Chercher sur inrees.com';}" onfocus="if(this.value== 'Chercher sur inrees.com' ){this.value='';}" title="recherche" maxlength="255" value="Chercher sur inrees.com" style="width:210px;" name="r" /> <input type="Submit" value="Ok" />{/literal}
							</form>
						</div>
