<div id="main">
	...
	<br /><br />
	<h3><a href="admin.php?cat=messagerie&scat=unlabelled">Boite de réception</a> - <font class="error">{$awaitingMessagesCount} messages en attente</font></h3><br />
	...
	<table cellspacing="1" style="width:100%;">
		...
		<tbody>
			{if ($awaitingMessagesCount != '0')}
				{foreach from=$awaitingMessages item='message'}
					<tr class="row6red">
						<td>{$message.id}</td>
						<td>
