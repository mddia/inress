...
<h6>Website / Vidéos / Modifier une vidéo</h6>
<br /><hr /><br />



<h1>Modifier une vidéo</h1><br />
	...
	<fieldset>
		...
		<table style="width:575px;">
			...
			<tr>
				...
				<td style="text-align:left;">
					<input style="width:250px;" name="url" type="text" value="{$video.url}" /> llllala
				</td>
			</tr>
			<tr>
				<td style="text-align:right;"><strong>Titre :</strong></td>
				<td style="text-align:left;">
					<input style="width:250px;" name="titre" type="text" value="{$video.titre}" />
				</td>
			</tr>
			<tr>
				<td style="text-align:right;"><strong>Sous-Titre :</strong></td>
				<td style="text-align:left;"><input style="width:250px;" name="sst" type="text" value="{$video.sst}" /></td>
			</tr>
			<tr>
				<td style="text-align:right;"></td>
				<td style="text-align:left;"></td>
			...
			<tr>
				...
				<td style="text-align:left;">
					<input style="width:150px;" name="dureeS" type="text" value="{$video.dureeS}" />
				</td>
			</tr>
			<tr>
				<td style="text-align:right;"></td><td style="text-align:left;"></td>
			...
			<tr>
				<td style="text-align:right;">
					Assigner ce video à une conférence :
				</td>
				<td style="text-align:left;">
