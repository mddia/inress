<div id="main">
	...
	Liste de <strong>tous les messages sans réponses</strong> du label <strong>{$thisLabel.name}</strong>.

	<br /><br />
	<h3><a href="admin.php?cat=messagerie&scat=unlabelled">Boite de réception</a> - <font class="error">{$awaitingLabelledMessages.count} messages en attente</font></h3><br />
	...
	<table cellspacing="1" style="width:100%;">
		...
		<tbody>
			{if ($awaitingLabelledMessages.count != '0')}
				{foreach from=$awaitingLabelledMessages.details item='message'}
					<tr class="row6red">
						<td>{$message.id}</td>
						<td>
