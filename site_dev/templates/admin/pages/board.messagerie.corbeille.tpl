<div id="main">
	<h6>Messagerie / Messages supprimés</h6>
	<br /><hr /><br />
	...
	Liste de <strong>tous les messages supprimés</strong>.

	<br /><br />
	<h3><a href="admin.php?cat=messagerie&scat=unlabelled">Boite de réception</a> - <font class="error">{$deletedMessagesCount} messages supprimés</font></h3><br />
	...
	<table cellspacing="1" style="width:100%;">
		...
		<tbody>
			{if ($deletedMessagesCount != '0')}
				{foreach from=$deletedMessages item='message'}
					<tr class="row6red">
						<td>{$message.id}</td>
						<td>
